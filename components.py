...
def display_initial_ai_message():
    ...
    with st.chat_message("assistant"):
        ...
        # 【問題3】Start 注意喚起メッセージの表示
        st.warning("具体的に入力したほうが期待通りの回答を得やすいです。")
        # 【問題3】End 注意喚起メッセージの表示


# 【問題3】Start サイドバー関数の追加
def display_sidebar():
    """
    サイドバーの表示
    """
